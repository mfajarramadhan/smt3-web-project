                        ...
                        <div class="t_body">
                            <table border="0" cellpadding="10" cellspacing="0">
                                <tr>
                                    ...
                                    <input type="text" name="nama" id="nama" placeholder="Masukkan nama..." autocomplete="off" required></td>
                                </tr>
                                <tr>
                                    <td><label for="username">Username :</label><br>
                                    <input type="text" name="username" id="username" placeholder="Username..." autocomplete="off" required></td>
                                </tr>
                                <tr>
                                    <td><label for="password">Password :</label><br>
                                    <input type="password" name="password" id="password" placeholder="Masukkan password..." autocomplete="off" required></td>
                                </tr>
                                <tr>
                                    <td><label for="password2">Konfirmasi Password :</label><br>
                                    <input type="password" name="password2" id="password2" placeholder="Masukkan ulang password..." autocomplete="off" required></td>
                                </tr>
                                <tr>
