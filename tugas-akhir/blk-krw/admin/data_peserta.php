...
$peserta = query("SELECT * FROM tbl_peserta, tbl_kecamatan, tbl_desa, tbl_kejuruan, tbl_sekolah 
    WHERE   
        tbl_peserta.id_kecamatan =  tbl_kecamatan.id && 
        tbl_peserta.id_desa = tbl_desa.id &&
        tbl_peserta.id_kejuruan = tbl_kejuruan.id &&
        tbl_peserta.asal_sekolah = tbl_sekolah.npsn ORDER BY nama ASC");
